...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("\n\n*** Results Summary for CNN Model Architecture", f"{model}".upper(), 
          "***")
    ...
    print("\n\n*** Results Summary Statistics (percentages) for CNN Model Architecture", f"{model}".upper(), 
          "***")
    ...
    if (print_incorrect_breed and 
        ...
        for key in results_dic:
            ...
            if ( sum(results_dic[key][3:]) == 2 and
                results_dic[key][2] == 0 ):
                print("Real Pet Label: {:>26}   Classifier Label: {:>30}".format(results_dic[key][0],
                                                          results_dic[key][1]))
